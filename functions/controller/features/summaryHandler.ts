                            ...
                            contents: [
                                {
                                    ...
                                    width: JSON.stringify(((dailySpending/dailyGoal) * 100).toFixed(2)) + "%",
                    ...
                    contents: [
                        {
                            ...
                            contents: [
                                {
                                    type: "text",
                                    text: JSON.stringify(dailySpending) + "/" + dailyGoal + "฿",
                                    color: "#8C8C8C",
                                    size: "sm",
                                    wrap: true
                                }
            ...
            },
            {
                ...
                header: {
                    ...
                    contents: [
                        ...
                        {
                            type: "text",
                            text: JSON.stringify(((monthlySpending/monthlyGoal) * 100).toFixed(2)) + "%",
                            color: "#ffffff",
                            align: "start",
                            size: "xs",
                            gravity: "center",
